...
export const metadata: Metadata = {
  title: "АВТОВЫКУП Тула - Срочный выкуп автомобилей за 15 минут",
  description: "Срочный выкуп автомобилей в Туле. Выкупаем машины любого состояния: после ДТП, неисправные, с пробегом. Бесплатный вывоз по Туле. Звоните: 89105250060",
  keywords: ["выкуп авто Тула", "выкуп автомобилей Тула", "продать авто Тула", "срочный выкуп авто Тула", "выкуп битых авто Тула"],
  alternates: {
    canonical: "https://vikupavto40.ru/tula"
  }
};
    ...
    <main className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-red-600/20 border border-red-500/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-red-400 font-medium">Тула</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8">
              Выкупаем автомобили, мотоциклы и спецтехнику в Туле и Тульской области. 
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <p className="text-gray-400">Оцениваем ваш автомобиль за 15 минут. Приезжаем в любой район Тулы</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <p className="text-gray-400">Эвакуатор за наш счёт в любую точку Тулы и области</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">ПРОДАЙ АВТО В ТУЛЕ ЗА 15 МИНУТ</h2>
      ...
      <footer className="py-8 border-t border-white/10 text-center text-gray-500">
        <div className="container mx-auto px-4">
          <p>© 2026 АВТОВЫКУП Тула. Все права защищены.</p>
        </div>
      </footer>
    </main>
  );
