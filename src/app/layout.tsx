...
export const metadata: Metadata = {
  ...
  title: {
    default: "АВТОВЫКУП ДОРОГО Калуга, Тула, Обнинск - Выкуп автомобилей за 15 минут",
    template: "%s | АВТОВЫКУП ДОРОГО"
  },
  ...
  authors: [{ name: "АВТОВЫКУП ДОРОГО" }],
  creator: "АВТОВЫКУП ДОРОГО",
  publisher: "АВТОВЫКУП ДОРОГО",
  formatDetection: {
    email: false,
    address: false,
    telephone: true
  ...
  openGraph: {
    title: "АВТОВЫКУП ДОРОГО Калуга, Тула, Обнинск - Выкуп автомобилей за 15 минут",
